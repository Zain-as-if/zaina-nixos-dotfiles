...
rofi_command="rofi -dmenu -theme ${HOME}/.dotfiles/config/rofi/wallSelect.rasi -theme-str ${rofi_override}"
...
rofi_override="element-icon{size:${monitor_res}px;border-radius:1px;}"
